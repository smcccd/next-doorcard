...
describe('LoginPage', () => {
  ...
  it('renders login form with OneLogin button', () => {
    ...
    expect(screen.getByRole('heading', { name: /sign in to faculty doorcards/i })).toBeInTheDocument()
    expect(screen.getByRole('button', { name: /sign in with smccd onelogin/i })).toBeInTheDocument()
  ...
  it('handles OneLogin authentication', async () => {
    ...
    const oneLoginButton = screen.getByRole('button', { name: /sign in with smccd onelogin/i })
  ...
  it('shows development credentials toggle in development mode', () => {
    ...
    expect(screen.getByRole('button', { name: /show development login/i })).toBeInTheDocument()
  })
  ...
  it('does not show development credentials in production', () => {
    ...
    expect(screen.queryByRole('button', { name: /show development login/i })).not.toBeInTheDocument()
  })
  ...
  describe('Development credentials form', () => {
    ...
    it('shows credentials form when development toggle is clicked', async () => {
      ...
      const showCredentialsButton = screen.getByRole('button', { name: /show development login/i })
  ...
  describe('Error handling', () => {
    it('displays OneLogin authentication errors', async () => {
      mockSignIn.mockResolvedValueOnce({ ok: false, error: 'Authentication failed' } as any)
  ...
  describe('Edge cases', () => {
    ...
    it('prevents double submission', async () => {
      process.env.NODE_ENV = 'development'
      mockSignIn.mockImplementation(() => new Promise(resolve => setTimeout(() => resolve({ ok: true, error: null } as any), 1000)))
