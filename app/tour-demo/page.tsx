  ...
  const demoTourSteps: TourStep[] = [
    {
      ...
      popover: {
        ...
        description: 'This page demonstrates the interactive tour system with user input requirements. Each step will guide you through different interactions.',
    ...
    },
    {
      ...
      popover: {
        ...
        description: 'Please type your name in this field. The tour will not continue until you provide input.',
    ...
    },
    {
      ...
      popover: {
        ...
        description: 'Now, please enter your email address. Notice how the "Next" button is disabled until you complete the input.',
        waitForUserInput: true,
        requiredInputType: 'input',
    ...
    },
    {
      ...
      popover: {
        ...
        description: 'Choose your college from this dropdown. The tour waits for your selection.',
        waitForUserInput: true,
    ...
    },
    {
      ...
      popover: {
        ...
        description: 'This field is optional - you can proceed without filling it in. Notice that you can use Next/Previous buttons freely here.',
    ...
    },
    {
      ...
      popover: {
        title: 'Submit Button',
        description: 'Click this submit button to complete the demo. This demonstrates waiting for a specific click action.',
        waitForUserInput: true,
    ...
    },
    {
      ...
      popover: {
        title: '✅ Tour Complete!',
        description: 'Congratulations! You\'ve completed the interactive tour demo. You can see how user inputs control the flow while still allowing backward navigation.',
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="mb-8 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
          Experience how tours can guide users through forms with input requirements
        </p>
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                This form demonstrates tour interactions with different input types
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          {/* Completion Card */}
          <Card id="completion-card" className="mt-6 border-green-200 dark:border-green-800">
            <CardHeader>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Tours can require user input before proceeding. Steps marked with <code>waitForUserInput: true</code> 
                will prevent progression until the user completes the required action.
              </p>
            </div>
            <div>
              <h4 className="font-semibold mb-2">Flexible Navigation</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Users can always navigate backward through tour steps, even when input is required. 
                Only forward progression is controlled by input completion.
              </p>
            </div>
            <div>
              <h4 className="font-semibold mb-2">Input Types</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Supports multiple input types: <code>click</code>, <code>input</code>, <code>select</code>, 
                and <code>custom</code> with validation functions.
              </p>
            </div>
            <div>
              <h4 className="font-semibold mb-2">Visual Feedback</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Real-time progress tracking and input completion status with clear visual indicators 
                and disabled states for improved UX.
              </p>
            </div>
          </div>
        </CardContent>
