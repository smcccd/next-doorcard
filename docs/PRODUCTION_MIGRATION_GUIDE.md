...
**Last Updated**: November 24, 2025 **Project**: Next Doorcard - Faculty
Doorcard System **Current Status**: Development → Production Migration

---

## Overview

This guide covers migrating the Next Doorcard application from development to
