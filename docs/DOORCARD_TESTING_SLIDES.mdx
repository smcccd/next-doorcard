...
- **Cultural names**: Had to handle "Dr. María de la Cruz" properly

### Technical Hurdles
- **Jest → Vitest migration**: Still 50% complete
...
2. **Long names**: "Dr. María Fernández de la Cruz-González"
...
- **Campus colors**: Skyline=red, CSM=blue, Cañada=green
...
*That's how we make it stronger!*