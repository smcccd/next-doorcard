...
describe('Doorcard Constants', () => {
  ...
  describe('Time Slots', () => {
    ...
    it('should handle noon correctly', () => {
      const noonSlot = TIME_SLOTS.find(slot => slot.hour === 12 && slot.minute === 0);
  ...
  describe('extractCourseCode', () => {
    it('should extract course codes with delimiters', () => {
      expect(extractCourseCode('CS 101 - Introduction to Programming')).toBe('CS 101');
    ...
    it('should truncate long activities', () => {
      const longActivity = 'Very Long Activity Name That Exceeds Twelve Characters';
