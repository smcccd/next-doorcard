import { withAuth, draftService } from '../api-utils';
  ...
  describe('draftService', () => {
    ...
    describe('getOne', () => {
      ...
      it('should throw error if draft not found', async () => {
        ...
        await expect(draftService.getOne(userId, draftId)).rejects.toThrow('Draft not found');
      });
    });
    ...
    describe('getByOriginalDoorcard', () => {
      it('should retrieve drafts for a specific original doorcard', async () => {
        ...
        const result = await draftService.getByOriginalDoorcard(userId, originalDoorcardId);
    ...
    describe('deleteByOriginalDoorcard', () => {
      it('should delete drafts for a specific original doorcard', async () => {
        ...
        const result = await draftService.deleteByOriginalDoorcard(userId, originalDoorcardId);
