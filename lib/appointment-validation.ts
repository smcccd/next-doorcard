...
export function normalizeAppointments(
  blocks: z.infer<typeof timeBlockSchema>[] | undefined,
  doorcardId: string
): Array<{
  id?: string;
  doorcardId: string;
  ...
  return blocks.map((b) => ({
    ...
    endTime: b.endTime,
    dayOfWeek: (b.dayOfWeek || b.day || "MONDAY") as DayOfWeek,
    category: (b.category || "OFFICE_HOURS") as AppointmentCategory,
    location: b.location ?? null,
  }));
}

// Schema for validating time block input
