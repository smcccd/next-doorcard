        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <Card>
                <CardContent className="p-4 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">{data.uniqueViews.toLocaleString()}</p>
                  </div>
              ...
              <Card>
                <CardContent className="p-4 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">{data.totalPrints.toLocaleString()}</p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-indigo-600">{data.engagementScore}/100</p>
              ...
              <Card>
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-gray-600">
                    Activity trends will appear here once there's more engagement data.
                  </p>
                </CardContent>
              </Card>
            )}
          ...
          <TabsContent value="doorcards" className="space-y-6 mt-6">
            {topDoorcards.length > 0 ? (
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">Top Performing Doorcards</CardTitle>
                </CardHeader>
                <CardContent>
                  <ResponsiveContainer width="100%" height={400}>
                    <BarChart data={topDoorcards} layout="horizontal">
                      ...
                      <Bar dataKey="prints" fill={COLORS.prints} name="Prints" />
              ...
              <Card>
                <CardContent className="p-12 text-center">
                  ...
                  <h3 className="text-lg font-semibold mb-2">No Doorcard Data</h3>
                  <p className="text-gray-600">
                    Individual doorcard analytics will appear here once there's activity.
                  </p>
                </CardContent>
              </Card>
            )}
