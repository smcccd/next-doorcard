...
import type { DoorcardLite, AppointmentLite } from '@/components/UnifiedDoorcard';
...
describe('UnifiedDoorcard', () => {
  ...
  describe('Header Information', () => {
    ...
    it('should display faculty name with proper formatting', () => {
      ...
      expect(screen.getByText('Test Professor (they/them)')).toBeInTheDocument();
    });
  ...
  describe('Schedule Grid', () => {
    ...
    it('should display weekend headers when showWeekendDays is true', () => {
      render(<UnifiedDoorcard doorcard={mockDoorcard} showWeekendDays={true} />);
    ...
    it('should hide weekend headers when showWeekendDays is false', () => {
      render(<UnifiedDoorcard doorcard={mockDoorcard} showWeekendDays={false} />);
  ...
  describe('Appointments', () => {
    it('should display appointments in correct time slots', () => {
      const doorcardWithAppointments = { ...mockDoorcard, appointments: mockAppointments };
  ...
  describe('Website Link', () => {
    it('should display website link when available', () => {
      ...
      const websiteLink = screen.getByRole('link', { name: /faculty website/i });
    ...
    it('should not display website section when no website', () => {
      ...
      expect(screen.queryByRole('link', { name: /faculty website/i })).not.toBeInTheDocument();
    });
  });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle missing name fields', () => {
      const doorcardWithPartialUser = {
        ...mockDoorcard,
        name: undefined,
        user: { ...mockDoorcard.user, name: null, firstName: null, lastName: null },
      };
