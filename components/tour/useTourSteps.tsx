...
export const DASHBOARD_TOUR_STEPS: TourStep[] = [
  {
    ...
    popover: {
      ...
      description: 'Let\'s take a quick tour to help you get started with creating and managing your doorcards.',
  ...
  },
  {
    ...
    popover: {
      ...
      description: 'Access your profile settings, view analytics, and manage your account from here.',
      nextBtnText: 'Next',
  ...
  },
  {
    ...
    popover: {
      ...
      description: 'Click here to create a new doorcard for the current term. Try clicking this button now!',
  ...
  },
  {
    ...
    popover: {
      ...
      description: 'Here you can see all your existing doorcards. You can edit, view, or duplicate them.',
      nextBtnText: 'Next',
      prevBtnText: 'Back'
    }
  },
  {
    ...
    popover: {
      ...
      description: 'Use this alphabetical index to quickly navigate to different sections of the site.',
      nextBtnText: 'Next',
      prevBtnText: 'Back'
    }
  }
...
export const NEW_DOORCARD_TOUR_STEPS: TourStep[] = [
  {
    ...
    popover: {
      ...
      description: 'This form will help you create a professional doorcard with your office hours and contact information.',
  ...
  },
  {
    ...
    popover: {
      ...
      description: 'Enter your name as you want it to appear on your doorcard. Please type your name now.',
      waitForUserInput: true,
  ...
  },
  {
    ...
    popover: {
      ...
      description: 'Choose which college you belong to. Please make a selection now.',
      waitForUserInput: true,
  ...
  },
  {
    ...
    popover: {
      ...
      description: 'When you\'re ready, click submit to create your doorcard. You can always edit it later!',
...
export const EDIT_DOORCARD_TOUR_STEPS: TourStep[] = [
  {
    ...
    popover: {
      ...
      description: 'Here you can update your doorcard information, add office hours, and customize your display.',
  ...
  },
  {
    ...
    popover: {
      ...
      description: 'Update your name, title, and contact information in this section.',
      nextBtnText: 'Next'
    }
  },
  {
    ...
    popover: {
      ...
      description: 'Add your office hours and appointment types here. Students will see when you\'re available.',
      nextBtnText: 'Next'
    }
  },
  {
    ...
    popover: {
      ...
      description: 'Click this button to add new office hours. Try clicking it now!',
      waitForUserInput: true,
      requiredInputType: 'click',
  ...
  },
  {
    ...
    popover: {
      ...
      description: 'Don\'t forget to save your changes when you\'re done editing!',
      doneBtnText: 'Finish'
    }
  }
];
...
export const useTourSteps = () => {
  ...
  const addTourAttributes = useCallback((elementId: string, tourId: string) => {
    const element = document.getElementById(elementId) || document.querySelector(`[data-testid="${elementId}"]`);
    if (element) {
  ...
  const prepareDashboardForTour = useCallback(() => {
    ...
    setTimeout(() => {
      const elements = [
        ...
        { selector: '[data-testid="create-doorcard-btn"]', tourId: 'create-doorcard-btn' },
        { selector: '[data-testid="doorcard-grid"]', tourId: 'doorcard-grid' },
        { selector: '.site-index, [data-testid="site-index"]', tourId: 'site-index' }
      ];
  ...
  const prepareNewDoorcardForTour = useCallback(() => {
    setTimeout(() => {
      const elements = [
        ...
        { selector: 'select[name="college"], #college-select', tourId: 'college-select' },
        { selector: 'input[name="officeNumber"], #office-input', tourId: 'office-input' },
        { selector: 'button[type="submit"], #submit-btn', tourId: 'submit-btn' }
      ];
  ...
  const prepareEditDoorcardForTour = useCallback(() => {
    setTimeout(() => {
      const elements = [
        { selector: '[data-testid="basic-info-tab"], .tab-basic-info', tourId: 'basic-info-tab' },
        { selector: '[data-testid="office-hours-tab"], .tab-office-hours', tourId: 'office-hours-tab' },
        { selector: '[data-testid="add-office-hours-btn"], .add-office-hours', tourId: 'add-office-hours-btn' },
        { selector: '[data-testid="save-btn"], button[type="submit"]', tourId: 'save-btn' }
      ];
